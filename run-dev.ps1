# Tilt Development Runner - PowerShell

Write-Host "=== Running Tilt (Development Mode) ==="
Write-Host "Detected platform: Windows x86_64"
Write-Host "Using Windows development image"
...
Write-Host "Starting development container ($ImageTag)..."
